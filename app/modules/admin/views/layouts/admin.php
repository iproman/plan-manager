...
$themeBundle = Yii::$app->getAssetManager()->getBundle(EshopperAsset::class);
                    ...
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="<?= \yii\helpers\Url::home() ?>">
                                <?= Html::img('@web/images/home/logo.png', ['alt' => 'E_SHOPPER']) ?>
                            </a>
                        </div>
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                <?php if (Yii::$app->user->isGuest): ?>
                                    <li><a href="<?= Url::to(['/admin']) ?>"><i class="fa fa-sign-in"></i> Ввойти</a>
                                    </li>
                                <?php endif; ?>
                                <?php if (!Yii::$app->user->isGuest): ?>
                                    <li><a href="<?= Url::to(['/admin']) ?>"><i
                                                    class="fa fa-user"></i> <?= Yii::$app->user->identity['username'] ?>
                                        </a>
                                    </li>
                                <?php endif; ?>
                                <?php if (!Yii::$app->user->isGuest): ?>
                                    <li><a href="<?= Url::to(['/site/logout']) ?>"><i class="fa fa-sign-out"></i> Выйти</a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </div>
            ...
            <div class="col-md-12">
                ...
                <?php if (Yii::$app->session->hasFlash('success')): ?>
                    <div class="alert alert-success">
                        <strong>Отлично!</strong> <?= Yii::$app->session->getFlash('success'); ?>
                    </div>
                <?php endif; ?>

                <?php if (Yii::$app->session->hasFlash('error')): ?>
                    <div class="alert alert-danger">
                        <strong>Что-то пошло не так!</strong> <?= Yii::$app->session->getFlash('error'); ?>
                    </div>
                <?php endif; ?>
